...
shp = r'/home/vpremier/Documents/git/sca4provbz/shapefile/SouthTyrol.geojson'
...
fileList = glob.glob(download_dir + os.sep + 'VNP10A1F.A2026*.h5')
fileList.sort()
...
# list of downloaded files
fileList = glob.glob(download_dir + os.sep + 'VNP10A1F.A202603*.h5')
...
# extent_target = [255480,5132990,305480,5182990]
